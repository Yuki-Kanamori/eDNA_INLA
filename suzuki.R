...
c_fish = data %>% filter(FISH == "suzuki")
...
res_suzu$waic$waic; res_suzu$dic$dic #640.3, 640.4
summary(res_suzu)
...
# range_e = apply(coop, 2, range)
proj_e = inla.mesh.projector(mesh2, xlim = range_e[, 1], ylim = range_e[, 2], dims = c(50, 50))
mean_s_ic2 = inla.mesh.project(proj_e, best_suzu$summary.random$i.c2$mean)
sd_s_ic2 = inla.mesh.project(proj_e, best_suzu$summary.random$i.c2$sd)
...
# range_e = apply(coop, 2, range)
proj_e = inla.mesh.projector(mesh2, xlim = range_e[, 1], ylim = range_e[, 2], dims = c(50, 50))
mean_s_ie2 = inla.mesh.project(proj_e, best_suzu$summary.random$i.e2$mean)
sd_s_ie2 = inla.mesh.project(proj_e, best_suzu$summary.random$i.e2$sd)
