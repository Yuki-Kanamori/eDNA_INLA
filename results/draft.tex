...
To estimate the spatial distribution from eDNA considering with spatial biases due to degradation from environmental factors (e.g., temperature and advection), 
